...
class Order(models.Model):
    ...
    booking = models.ForeignKey(Booking, on_delete=models.SET_NULL, related_name='booking_order', null=True)
    turf = models.ForeignKey(Turf, on_delete = models.SET_NULL, related_name = 'ordered_turf', null = True)
    def __str__(self):
